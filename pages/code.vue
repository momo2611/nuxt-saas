<template>
    <div>
        <Heading title="Code Generator" description="Generate code using descriptive text." icon="lucide:code"
            ...
            <div>
                <form @submit.prevent="submitPrompt"
                    ...
                    <div class="col-span-12 lg:col-span-10">
                        <div class="m-0 p-0">
                            <input v-model="prompt" placeholder="How do I calculate the radius of a circle?"
